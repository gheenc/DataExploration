...
percent <- round(table1["Your wallet"]/sum(table1) *100) 
percent
...
barplot((table1), 
        ...
        ylab = "Response Options",
        names.arg = names(table1)) # ADDING PERCENT TO THE LABELS IS NOT DONE
```
...
```{r}
table(okcupid$q53, okcupid$p_conf)
