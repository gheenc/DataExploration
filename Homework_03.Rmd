...
# 2.5 loop plotting
for (i in vec) {
  qqplot(rbinom(127, i, 0.3), vec,
  pch = 19,
  col.lines = "blue",
  main = paste("127 Binomial Sample, N = ", i)
  )
}
...
*There was at least one food that would have been erraneously categorized *
